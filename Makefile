UVM_HOME = /proj/verif_release_ro/uvmkit-1.2/4.0.1/uvm
...
VCS =	vcs -sverilog -timescale=1ns/1ns \
	...
	$(UVM_HOME)/src/dpi/uvm_dpi.cc -CFLAGS -DVCS -debug_all -P ${VERDI_HOME}/share/PLI/VCS/linux/novas.tab ${VERDI_HOME}/share/PLI/VCS/linux/pli.a 
